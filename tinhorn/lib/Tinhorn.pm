...
our @EXPORT_OK = qw(
	verify_dependencies
	verify_configuration update_configuration
	start_console start_webserver start_harvest
	all_tests_pass unit_tests_pass integration_tests_pass functional_tests_pass
);

use Tinhorn::App::Console;
use Tinhorn::App::Harvest;
use Tinhorn::App::Webserver;
use Tinhorn::Controller::Dependencies;
use Tinhorn::Model::Country;
use Tinhorn::Model::Currency;
use Tinhorn::Model::Exchange;
use Tinhorn::Model::Instrument;
use Tinhorn::Model::HarvestRequest;
use Tinhorn::Model::MarketRate;
use Tinhorn::Model::Message;
...
=item c<start_harvest>

Starts the Tinhorn::App::Harvest service
...
sub start_harvest {
	...
	return Tinhorn::App::Harvest->new()->run();
}
